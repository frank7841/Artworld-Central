        ...
        <Card className="border-none shadow-2xl backdrop-blur-sm bg-card/95">
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 text-lg font-bold mt-4 shadow-lg hover:shadow-xl transition-shadow"
                disabled={loading}
              >
                {loading ? (
                  <>
          ...
          <CardFooter className="flex flex-col gap-4">
            <div className="relative w-full">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-card px-2 text-muted-foreground">New to ArtWorld?</span></div>
            </div>
