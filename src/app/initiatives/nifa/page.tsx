                ...
                <div className="max-w-5xl mx-auto space-y-16">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {highlights.map((item, index) => (
                            <div key={index} className="p-8 rounded-3xl bg-primary/5 border border-primary/10 hover:bg-primary hover:text-white transition-all group">
                                ...
                                <p className="text-sm opacity-80 group-hover:opacity-100">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
